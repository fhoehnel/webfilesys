...
public class UserComparator implements Comparator {
	...
	public int compare(Object o1,Object o2) {
		...
		if (sortBy == SORT_BY_FIRST_NAME) {
            return compareStringAttrib(user1.getFirstName(), user2.getFirstName());
		}
		if (sortBy == SORT_BY_LAST_NAME) {
            return compareStringAttrib(user1.getLastName(), user2.getLastName());
		}
    ...
    private int compareStringAttrib(String attr1, String attr2) {
        if (attr1 == null) {
            if (attr2 == null) {
                return 0;
            } else {
        ...
        return attr1.toUpperCase().compareTo(attr2.toUpperCase());
    }
