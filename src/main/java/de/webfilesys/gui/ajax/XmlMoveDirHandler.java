 ...
 */
public class XmlMoveDirHandler extends XmlRequestHandlerBase
{
	public XmlMoveDirHandler(
	...
	protected void process()
	{
		...
		String resultMsg = getResource("label.directory","Directory") + "<br/> " + shortPath + "<br/> " + getResource("alert.dirmoved","has been selected for move opeartion");
