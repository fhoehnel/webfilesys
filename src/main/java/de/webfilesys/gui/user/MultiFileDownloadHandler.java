...
public class MultiFileDownloadHandler extends MultiFileRequestHandler
{
	...
	protected void process()
	{
		...
		{
			LogManager.getLogger(getClass()).debug("MultiFileDownloadHandler: no files selected");
		...
		if (actPath == null)
		{
			LogManager.getLogger(getClass()).error("MultiFileDownloadHandler: actPath is null");
