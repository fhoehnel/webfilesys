...
<html>
  <head>
    ...
    <script src="/webfilesys/javascript/gpxOSM.js" type="text/javascript"></script>
  ...
  <body>
    <xsl:if test="/gpx/track">
      <xsl:attribute name="onload">showTracksOnOSM('<xsl:value-of select="/gpx/filePath" />')</xsl:attribute>
    </xsl:if>
