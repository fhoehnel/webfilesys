...
{
    descWin=window.open("/webfilesys/servlet?command=editMetaInf&path=" + encodeURIComponent(path) + "&geoTag=true&random=" + new Date().getTime(),"descWin","status=no,toolbar=no,location=no,menu=no,width=600,height=630,scrollbars=yes,resizable=yes,left=20,top=10,screenX=20,screenY=10");
    descWin.focus();
...
function searchGPS(path, folderName) { 
	searchWin=open("/webfilesys/servlet?command=searchGPSParms&actpath=" + encodeURIComponent(path),"SearchGPS","scrollbars=yes,resizable=yes,width=640,height=500,left=20,top=10,screenX=80,screenY=10");
	searchWin.focus();
	searchWin.opener=self;
}